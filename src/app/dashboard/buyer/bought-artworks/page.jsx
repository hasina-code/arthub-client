      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 border-b border-slate-800 pb-6">
          ...
          <p className="text-slate-400 mt-2 text-lg">
            A curated list of masterpieces
            you've acquired.
          </p>
        </div>
            ...
            {artworks.map((item) => (
              ...
              >
                ...
                <div className="relative overflow-hidden h-64">
                  ...
                  <div className="absolute top-4 right-4 bg-white/40 backdrop-blur-md text-red-500 px-4 py-1 rounded-full text-sm font-bold border border-white/40">
                  SOLD
                 </div>
